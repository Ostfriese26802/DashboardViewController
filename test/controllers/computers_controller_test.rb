...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { fqdn: @computer.fqdn, gruppe_id: @computer.gruppe_id, standort: @computer.standort, url: @computer.url } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { fqdn: @computer.fqdn, gruppe_id: @computer.gruppe_id, standort: @computer.standort, url: @computer.url } }
